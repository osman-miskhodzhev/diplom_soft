...
for x in range(8):
    ...
    os.system(f'iperf3 -c 192.168.1.101 -t 60 -u --logfile ex1-router1-channe-{x+2}.txt')
...
os.system(f'iperf3 -c 192.168.1.101 -t 60 -u --logfile ex1-router1-channel-{10}.txt')
print(datetime.datetime.now())
...
os.system(f'iperf3 -c 192.168.1.101 -t 60 -u --logfile ex1-router1-channel-{11}.txt')
print(datetime.datetime.now())
...
os.system(f'iperf3 -c 192.168.1.101 -t 60 -u --logfile ex1-router1-channel-{12}.txt')
print(datetime.datetime.now())
...
os.system(f'iperf3 -c 192.168.1.101 -t 60 -u --logfile ex1-router1-channel-{13}.txt')
print(datetime.datetime.now())
